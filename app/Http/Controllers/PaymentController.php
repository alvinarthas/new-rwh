...
class PaymentController extends Controller
{
    ...
    public function salesCreate(Request $request, $id){
        ...
        $coas = Coa::where('StatusAccount','Detail')->where('AccNo','LIKE','1.1.1.2.%')->orWhere('AccNo','LIKE','1.1.1.1.%')->orderBy('AccName','asc')->get();
        $page = MenuMapping::getMap(session('user_id'),"PSSP");
    ...
    public function purchaseCreate(Request $request,$id){
        ...
        $coas = Coa::where('StatusAccount','Detail')->where('AccNo','LIKE','1.1.1.2.%')->orWhere('AccNo','LIKE','1.1.1.1.%')->orWhere('AccNo','LIKE','2.5%')->orderBy('AccName','asc')->get();
        $page = MenuMapping::getMap(session('user_id'),"PUPP");
