    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box table-responsive">
                ...
                @if (array_search("FIPKC",$page))
                <a href="{{route('piutang.create')}}" class="btn btn-success btn-rounded waves-effect waves-light w-md m-b-5">Tambah Data Piutang Karyawan</a>
                @endif
        ...
        <div class="modal-dialog modal-lg" id="do-modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">Detail Piutang Karyawan</h4>
