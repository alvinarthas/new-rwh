            ...
            <div class="card-box">
                <div class="bg-picture card-box">
                    <div class="profile-info-name">
                        <img src="{{ asset('assets/images/employee/foto/'.$user->scanfoto) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="text-left">
                                        ...
                                        <p class="text-muted font-13"><strong>NIP :</strong><span class="m-l-15">{{$user->nip}}</span></p>
                                ...
                                <div class="col-md-6">
                                    <div class="text-left">
                                        <p class="text-muted font-13"><strong>Bank :</strong> <span class="m-l-15">{{$user->bank}}</span></p>

                                        <p class="text-muted font-13"><strong>Nomor Rekening :</strong> <span class="m-l-15">{{$user->norek}}</span></p>
    
                                        <p class="text-muted font-13"><strong>KTP :</strong> <span class="m-l-15">{{$user->ktp}}</span></p>
        
                                        <p class="text-muted font-13"><strong>SIM A :</strong> <span class="m-l-15">{{$user->sima}}</span></p>
        
                                        <p class="text-muted font-13"><strong>SIM C :</strong> <span class="m-l-15">{{$user->simc}}</span></p>
        
                                        <p class="text-muted font-13"><strong>SIM B1 :</strong> <span class="m-l-15">{{$user->simb}}</span></p>
        
                                        <p class="text-muted font-13"><strong>NPWP :</strong> <span class="m-l-15">{{$user->npwp}}</span></p>
        
                                        <p class="text-muted font-13"><strong>BPJS :</strong> <span class="m-l-15">{{$user->bpjs}}</span></p>
                                    </div>
                                </div>
                            </div>
