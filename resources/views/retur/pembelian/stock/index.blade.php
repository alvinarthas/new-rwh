    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box table-responsive">
                <h3 class="l-h-34">Retur Receive Product Pembelian Barang Report</h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (array_search("RBRPC",$page))
                                        <a href="{{ route("returbeli.editreceive", ["id" => $r['id']]) }}" class="btn btn-primary btn-rounded waves-effect waves-light">Retur Receive Product</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
