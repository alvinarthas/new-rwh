            ...
            <div class="card-box table-responsive">
                ...
                @elseif($jenis=="report")
                    @if($jenisretur=="penjualan")
                        ...
                        @if (array_search("RJSOC",$page))
                        <div class="form-group m-b-0">
                            <a href="{{ route("returjual.create") }}" class="btn btn-primary waves-effect waves-light">
                                ...
                                @foreach($retur as $r)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif --}}
                                            @if (array_search("RJSOD",$page))
                                            <a href="javascript:;" class="btn btn-danger btn-trans waves-effect w-md waves-danger m-b-5" onclick="deleteRetur({{$r->id}}, 'penjualan')">Delete</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @foreach($retur as $r)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif --}}
                                            @if (array_search("RBPOD",$page))
                                            <a href="javascript:;" class="btn btn-danger btn-trans waves-effect w-md waves-danger m-b-5" onclick="deleteRetur({{$r->id}}, 'pembelian')">Delete</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
...
<script type="text/javascript">
    ...
    function deleteRetur(id,jenis){
        var token = $("meta[name='csrf-token']").attr("content");
        if(jenis == "pembelian"){
            var url = "returbeli/"+id;
        }else if(jenis == "penjualan"){
            var url = "returjual/"+id;
        }
        console.log(url)
